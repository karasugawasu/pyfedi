...
from app.community.util import search_for_community, actor_to_community, \
    ...
    delete_post_from_community, delete_post_reply_from_community, community_in_list, find_local_users, find_all_users
...
def community_find_moderator(community_id: int):
    ...
    if community.is_owner() or current_user.is_admin():
        ...
        if form.validate_on_submit():
            potential_moderators = find_all_users(form.user_name.data)
